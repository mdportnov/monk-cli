...
complete -c monk -n "__fish_monk_needs_command" -f -a "setup" -d 'Interactive first-run setup wizard'
...
complete -c monk -n "__fish_monk_using_subcommand daemon; and not __fish_seen_subcommand_from start stop status run install uninstall help" -f -a "install" -d 'Install the daemon as a system service (requires sudo)'
complete -c monk -n "__fish_monk_using_subcommand daemon; and not __fish_seen_subcommand_from start stop status run install uninstall help" -f -a "uninstall" -d 'Remove the system service (add --purge to also wipe data)'
...
complete -c monk -n "__fish_monk_using_subcommand daemon; and __fish_seen_subcommand_from help" -f -a "install" -d 'Install the daemon as a system service (requires sudo)'
complete -c monk -n "__fish_monk_using_subcommand daemon; and __fish_seen_subcommand_from help" -f -a "uninstall" -d 'Remove the system service (add --purge to also wipe data)'
...
complete -c monk -n "__fish_monk_using_subcommand setup" -l locale -r -f -a "en\t''
ru\t''"
complete -c monk -n "__fish_monk_using_subcommand setup" -l non-interactive -d 'Skip interactive prompts, use defaults'
complete -c monk -n "__fish_monk_using_subcommand setup" -l no-daemon -d 'Skip daemon service installation'
complete -c monk -n "__fish_monk_using_subcommand setup" -l no-completions -d 'Skip shell completions installation'
complete -c monk -n "__fish_monk_using_subcommand setup" -l no-doctor -d 'Skip health checks'
complete -c monk -n "__fish_monk_using_subcommand setup" -s h -l help -d 'Print help'
complete -c monk -n "__fish_monk_using_subcommand setup" -s V -l version -d 'Print version'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions setup help" -f -a "init" -d 'Run the interactive onboarding wizard'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions setup help" -f -a "tui" -d 'Open the interactive TUI'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions setup help" -f -a "lang" -d 'Set the interface language'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions setup help" -f -a "start" -d 'Start a focus session'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions setup help" -f -a "stop" -d 'Stop the active session'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions setup help" -f -a "panic" -d 'Request an escape from hard mode'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions setup help" -f -a "status" -d 'Show daemon and session status'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions setup help" -f -a "profiles" -d 'List profiles'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions setup help" -f -a "profile" -d 'Manage profiles'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions setup help" -f -a "apps" -d 'Manage installed applications cache'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions setup help" -f -a "stats" -d 'Show session statistics'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions setup help" -f -a "doctor" -d 'Check environment, permissions, and daemon health'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions setup help" -f -a "config" -d 'Manage configuration'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions setup help" -f -a "daemon" -d 'Manage the background daemon'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions setup help" -f -a "completions" -d 'Generate shell completions'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions setup help" -f -a "setup" -d 'Interactive first-run setup wizard'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions setup help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c monk -n "__fish_monk_using_subcommand help; and __fish_seen_subcommand_from daemon" -f -a "install" -d 'Install the daemon as a system service (requires sudo)'
complete -c monk -n "__fish_monk_using_subcommand help; and __fish_seen_subcommand_from daemon" -f -a "uninstall" -d 'Remove the system service (add --purge to also wipe data)'
