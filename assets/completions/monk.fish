...
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions update help" -f -a "init" -d 'Run the interactive onboarding wizard'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions update help" -f -a "tui" -d 'Open the interactive TUI'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions update help" -f -a "lang" -d 'Set the interface language'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions update help" -f -a "start" -d 'Start a focus session'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions update help" -f -a "stop" -d 'Stop the active session'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions update help" -f -a "panic" -d 'Request an escape from hard mode'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions update help" -f -a "status" -d 'Show daemon and session status'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions update help" -f -a "profiles" -d 'List profiles'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions update help" -f -a "profile" -d 'Manage profiles'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions update help" -f -a "apps" -d 'Manage installed applications cache'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions update help" -f -a "stats" -d 'Show session statistics'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions update help" -f -a "doctor" -d 'Check environment, permissions, and daemon health'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions update help" -f -a "config" -d 'Manage configuration'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions update help" -f -a "daemon" -d 'Manage the background daemon'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions update help" -f -a "completions" -d 'Generate shell completions'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions update help" -f -a "update" -d 'Check GitHub releases for a new version and self-update'
complete -c monk -n "__fish_monk_using_subcommand help; and not __fish_seen_subcommand_from init tui lang start stop panic status profiles profile apps stats doctor config daemon completions update help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
